...
function Diy_Part2() {
	...
	export Github_API2="https://mirror.com/https://github.com/${GIT_REPOSITORY}/releases/download/${Update_tag}/zzz_api"
	export API_PATH="/tmp/Downloads/zzz_api"
	export Release_download1="${GITHUB_LINK}/releases/download/${Update_tag}"
	export Release_download2="https://mirror.com/${GITHUB_LINK}/releases/download/${Update_tag}"
