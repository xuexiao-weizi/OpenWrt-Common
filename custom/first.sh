...
if [[ -n "${BENDI_VERSION}" ]]; then
  ...
  sudo rm -rf build/common && git clone -b main --depth 1 https://github.com/xuexiao-weizi/OpenWrt-Common build/common
...
git clone -b main --depth 1 https://github.com/gxnas/OpenWrt_Build_x64_all shangyou
...
if [[ "${GIT_REPOSITORY}" =~ (28677160/build-actions|gxnas/OpenWrt_Build_x64_all) ]]; then
  rm -rf backups
...
curl -fsSL https://raw.githubusercontent.com/gxnas/OpenWrt-Common/main/common.sh -o common.sh
if [[ $? -ne 0 ]]; then
  wget -q https://raw.githubusercontent.com/gxnas/OpenWrt-Common/main/common.sh -O common.sh
fi
